...
augroup fswitch_au_group
    au!
    au BufEnter *.h call s:SetVariables('cpp,c', 'reg:/Include/Source/,reg:/include/source/,reg:/include.*/source/,ifrel:|/include/|../source|')
    au BufEnter *.c,*.cpp call s:SetVariables('h', 'reg:/Source/Include/,reg:/source/include/,reg:|source|include/**|,ifrel:|/source/|../include|')
augroup END
