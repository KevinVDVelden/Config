...
" Colors for the User Interface.
    ...
    "16 + 36*r + 6*g + b
    "232 + gray
    exec "hi Pmenu          cterm=NONE   ctermfg=251   ctermbg=17"
    ...
    exec "hi Search         cterm=NONE   ctermfg=255   ctermbg=60"
    ...
    " Spell check colors
    exec "hi SpellBad      cterm=NONE    ctermfg=196   ctermbg=233"
    exec "hi SpellCap      cterm=NONE    ctermfg=217   ctermbg=233"
    exec "hi SpellRare     cterm=NONE    ctermfg=160   ctermbg=233"
    exec "hi SpellLocal    cterm=NONE    ctermfg=181   ctermbg=233"
